...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer**: There are no headers, and R instead made the first row of data the header.
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer**: We still don't have column names or headers so we don't know what the items in the dataset actually mean.
...
**Task** Run the codeblock below. What else do we need to do? **Answer**: We need to make the table easier to look at by getting rid of the extra dotted lines in the jurisdiction column.
