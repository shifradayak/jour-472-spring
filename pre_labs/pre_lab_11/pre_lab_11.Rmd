...
**Answer**: The columns are the same as the one on the online table (one for the date and one for the name of the release).
...
**Answer**: I'd want to add a column with what office the release is from and what time it was sent out 
...
**Answer**: It suggests that there are three <ul> tags, since all of these <li> tags seem to be nested under one of three groupings/item types (links, menu items,and classes).
...
**Answer**: The output isolates the actual readable text inside of those <li> tags in the previous output. There are 128 pieces of text.
...
**Answer**: The output gives us a table that has each of these 122 pieces of text.
