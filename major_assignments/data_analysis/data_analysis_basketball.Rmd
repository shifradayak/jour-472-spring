...
We want to look at this question to see if there are trends in higher-performing states athletically in the U.S. — it would be interesting to form hypotheses about what factors might drive some states to produce more athletes than others. 
```{r}
roster_23_24 |>
...
```
The top 10 high schools that produced players are: New Hope Academy, IMG Academy, Notre Dame Academy, Sacred Heart Academy, Trinity, Example Academy, DeSoto High School, Dunmore, South Mecklenburg, and Centennial (in Las Vegas).
